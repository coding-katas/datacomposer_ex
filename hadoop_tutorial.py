...
HADOOP_JOB = {
    ...
    "placement": {"cluster_name": 'composer-hadoop-test-cluster-{{ ds_nodash }}'},
    "hadoop_job": {
...
with models.DAG(
    ...
    create_dataproc_cluster = dataproc.DataprocCreateClusterOperator(
        ...
        cluster_name='composer-hadoop-test-cluster-{{ ds_nodash }}',
